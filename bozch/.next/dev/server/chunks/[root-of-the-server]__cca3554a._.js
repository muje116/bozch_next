...
"[project]/app/api/admin/impact-stats/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("UPDATE impact_stats SET label = ?, value = ?, suffix = ?, icon = ?, display_order = ?, is_active = ?, updated_at = NOW() WHERE id = ?", [
            data.label,
            data.value,
            data.suffix,
            data.icon,
        ...
        const updatedStats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("SELECT * FROM impact_stats WHERE id = ?", [
            id
        ]);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedStats[0]);
    } catch (error) {
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("DELETE FROM impact_stats WHERE id = ?", [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cca3554a._.js.map