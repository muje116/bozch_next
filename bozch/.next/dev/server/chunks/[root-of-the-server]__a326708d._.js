...
"[project]/app/api/admin/team-members/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const members = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("SELECT * FROM team_members ORDER BY display_order ASC");
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("INSERT INTO team_members (name, role, bio, image_url, email, linkedin_url, display_order, is_active) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [
            data.name,
            data.role,
            data.bio,
            data.image_url,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newMember);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a326708d._.js.map