...
async function GET() {
    try {
        const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("SELECT * FROM site_settings ORDER BY setting_key ASC");
        const settingsMap = {};
        settings.forEach((s)=>{
...
async function PUT(request) {
    try {
        ...
        for (const [key, value] of Object.entries(data)){
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("INSERT INTO site_settings (setting_key, setting_value, updated_at) VALUES (?, ?, NOW()) ON DUPLICATE KEY UPDATE setting_value = ?, updated_at = NOW()", [
                key,
                value,
                value
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc4cd4cb._.js.map