...
"[project]/app/api/admin/milestones/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const milestones = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("SELECT * FROM milestones ORDER BY display_order ASC");
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(milestones);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("INSERT INTO milestones (year, title, description, display_order, is_active) VALUES (?, ?, ?, ?, ?)", [
            data.year,
            data.title,
            data.description,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newMilestone);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aac20f9b._.js.map