...
"[project]/app/api/admin/programs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const programs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("SELECT * FROM programs ORDER BY display_order ASC");
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("INSERT INTO programs (title, description, long_description, icon, image_url, display_order, is_active) VALUES (?, ?, ?, ?, ?, ?, ?)", [
            data.title,
            data.description,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81ccf4a2._.js.map