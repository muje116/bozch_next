...
;
;
const JWT_SECRET = new TextEncoder().encode(process.env.JWT_SECRET || "bozch-secret-key-change-in-production");
...
async function verifyPassword(password, hash) {
    try {
        ...
        const isMatch = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, hash);
        return isMatch;
    } catch (error) {
...
async function login(email, password) {
    try {
        ...
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("SELECT * FROM admin_users WHERE email = ?", [
            email
        ]);
...
"[project]/app/api/admin/hero-slides/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const slides = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("SELECT * FROM hero_slides ORDER BY display_order ASC");
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(slides);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("INSERT INTO hero_slides (title, subtitle, image_url, cta_text, cta_link, display_order, is_active) VALUES (?, ?, ?, ?, ?, ?, ?)", [
            data.title,
            data.subtitle,
            data.image_url,
            data.cta_text,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newSlide);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d3f48fff._.js.map