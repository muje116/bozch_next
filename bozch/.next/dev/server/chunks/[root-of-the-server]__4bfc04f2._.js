...
"[project]/app/api/admin/impact-stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const stats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("SELECT * FROM impact_stats ORDER BY display_order ASC");
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"])("INSERT INTO impact_stats (label, value, suffix, icon, display_order, is_active) VALUES (?, ?, ?, ?, ?, ?)", [
            data.label,
            data.value,
            data.suffix || "",
            data.icon,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newStat);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4bfc04f2._.js.map